...
namespace store_geek
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\thiag\\Downloads\\geek_store-app-main\\geek_store-app-main\\store_geek\\store_geek\\DbGeekStore.mdf;Integrated Security=True");
        ...
        private void btnLocalizar_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    con.Close();
                    con.Open();
                    SqlCommand lvenda = new SqlCommand("LocalizarVendidos", con);
